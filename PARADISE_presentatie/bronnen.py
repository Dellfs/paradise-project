...
BIJ_DIA = {
    ...
    'Twee derde recidiveert binnen vijf jaar': (1,),
    ...
    'draagtijd — gemeten,\nniet gevraagd': (13,),
    'Belasting is een product, geen optelsom': (14, 16),
    ...
    'Gedimensioneerd op het recidief': (9, 13),
    'De mediator draagt de verklaring, niet het oordeel': (9,),
