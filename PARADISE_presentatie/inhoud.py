...
SLIDES = [
 ...
 dict(t='knal', voor='p', morph='morph',
     ...
     # ================================================================
    # Kortrijk Kerngezond 2026 — tien minuten, ook voor schoolkinderen
    # ================================================================

    dict(t='hero_titel', voor='g', morph='fade',
         boven='PARADISE',
         ...
         tip='Laat deze dia staan terwijl de zaal binnenkomt. De voet rechts '
             'is een echte meting; wacht tot mensen ernaar kijken.',
         interactie='Vraag wie al eens op een drukmat heeft gestaan.'),

    dict(t='hero_cijfer', voor='g', morph='morph',
         cijfer='10.000', suffix='',
         kop='stappen zet je\nelke dag',
         tegels=[('26', 'botjes per voet'), ('2', 'voeten, heel je leven'),
                 ('0', 'reserve')],
         voet='Je voeten dragen je overal naartoe — en ze klagen zelden.',
         accent='groen2',
         tip='Begin hier bij het publiek zelf, niet bij de ziekte. Laat de zaal '
             'even voelen hoeveel stappen dat is.',
         interactie='Vraag wie vandaag al meer dan tienduizend stappen zette.'),

    dict(t='drieluik', voor='g', morph='morph',
         kicker='Wat diabetes met een voet doet',
         kop='Drie dingen tegelijk',
         kaarten=[dict(naam='Te veel druk', sub='Duwen', groot='200',
                       onder='kPa is veel', icoon='druk',
                       regels=['Op één plekje duwt de voet te hard.',
                               'Als een steentje dat er altijd zit.'],
                       wie='Meetbaar'),
                  dict(naam='Geen gevoel', sub='Voelen', groot='0',
                       onder='pijn', icoon='gevoel',
                       regels=['De zenuw geeft geen seintje.',
                               'Je voelt een wonde niet.'],
                       wie='Onzichtbaar'),
                  dict(naam='Te laat gezien', sub='Tijd', groot='40',
                       onder='procent', icoon='tijd',
                       regels=['Pas gezien als het al stuk is.',
                               'Op tijd kijken helpt.'],
                       wie='Te voorkomen')],
         tip='Drie kaarten, drie zinnen. Wijs ze aan terwijl u ze noemt.',
         interactie='Vraag wie ooit een blaar niet gevoeld heeft.'),

    dict(t='statement', voor='g', morph='morph',
         kicker='Wat wij doen',
         kop='Wij meten wat\neerst alleen\ngeschat werd',
         body='Zes ziekenhuizen in België zoeken samen uit of een zool die de '
              'druk echt wegneemt, én die ook gedragen wordt, nieuwe wonden '
              'voorkomt. AZ Groeninge in Kortrijk is er een van.',
         uitz_kop='Eerlijk gezegd',
         uitzondering='Het onderzoek start binnenkort. Er zijn nog geen '
                      'resultaten — wat u vandaag ziet, is hoe we het meten.',
         tip='Zeg dat er nog geen resultaten zijn. Dat wekt vertrouwen.',
         interactie='Geen.'),
    ...
    dict(t='duo', voor='g', morph='morph',
         ...
         twee=dict(nr='02', naam='Wat het doet', icoon='wandel',
                   kern='100 metingen per seconde',
                   regels=['Je wandelt tien meter, heen en weer.',
                           'Elke stap wordt opgemeten.',
                           'Na één minuut weten we waar het knelt.']),
         tip='Houd een echte zool omhoog. Dat doet meer dan de dia.',
         interactie='Laat de zool rondgaan in de zaal.'),

    dict(t='drukmeting', voor='g', morph='morph', fase='voor',
         ...
         regels=['Elk vierkantje is één voelertje. Hoe roder, hoe harder de '
                 ...
                 'wonde ontstaat.'],
         voet='Een echte meting duurt ongeveer één minuut.',
         tip='Dit is het beeld dat blijft hangen. Zeg niets tot iedereen '
             'gekeken heeft, wijs dan de rode plek aan.',
         interactie='Vraag aan de kinderen waar zij denken dat het pijn doet.'),

    dict(t='drukmeting', voor='g', morph='morph', fase='na',
         kicker='En met de juiste zool',
         kop='De rode plek koelt af',
         waarde='186', plek='op dezelfde plek, na aanpassing',
         norm='Onder 200 — gelukt',
         regels=['Dezelfde voet, dezelfde stap, maar nu met een zool die op '
                 'maat gemaakt is.',
                 'De druk is verdeeld over de hele voet in plaats van één '
                 'plekje.'],
         voet='Lukt het niet in één keer, dan past de maker de zool bij.',
         tip='Klik door zonder iets te zeggen. De zaal ziet de kleur veranderen '
             '— dat is het moment. Zeg pas daarna het cijfer.',
         interactie='Vraag of ze het zagen veranderen.'),

    dict(t='duo', voor='g', morph='morph',
         kicker='En dan nog iets',
         kop='Een goede zool in de kast helpt niemand',
         een=dict(nr='01', naam='Het probleem', icoon='huis',
                  kern='Thuis gaat de schoen uit',
                  regels=['Binnenshuis zet je de meeste stappen.',
                          'Net daar draag je je schoenen het minst.',
                          'Vragen hoe vaak helpt niet — niemand weet dat.']),
         twee=dict(nr='02', naam='De oplossing', foto='orthotimer.png',
                   kern='Een piepklein sensortje',
                   regels=['Zo groot als een halve suikerklont.',
                           'Het meet elk kwartier of de schoen warm is.',
                           'Geen camera, geen microfoon, geen GPS.']),
         tip='Noem meteen wat het níét doet. Dat is de eerste vraag.',
         interactie='Vraag of iemand zich daaraan zou storen.'),

    dict(t='vierluik', voor='g', morph='morph',
         kicker='Waar het naartoe gaat',
         kop='Zorg die meedenkt',
         kolommen=[('Kleiner', ['Sensoren passen overal in',
                                'Je merkt ze niet meer',
                                'Ook gewoon thuis']),
                   ('Slimmer', ['Computers zien patronen in duizenden stappen',
                                'Ze merken op wat een mens mist',
                                'De dokter beslist, niet de computer']),
                   ('Altijd', ['Nu: één meting per half jaar',
                               'Straks: een beeld dat meeloopt',
                               'Sneller bijsturen']),
                   ('Op tijd', ['Het risico zien voor de wonde er is',
                                'Ingrijpen als het nog klein is',
                                'Geen wonde, geen litteken'])],
         tip='Blijf voorzichtig: dit is de richting, niet wat vandaag al kan.',
         interactie='Geen.'),

    dict(t='drieluik', voor='g', morph='morph',
         kicker='Wie dit samen doet',
         kop='Onderzoek en ziekenhuis',
         kaarten=[dict(naam='KU Leuven', sub='Campus Brugge', groot='1',
                       onder='onderzoek', foto='kuleuven.png',
                       regels=['Bedenkt het onderzoek.',
                               'Meet en rekent uit.'],
                       wie='De wetenschap'),
                  dict(naam='AZ Groeninge', sub='Kortrijk', groot='1',
                       onder='van de zes', icoon='ziekenhuis',
                       regels=['Hier gebeurt de zorg.',
                               'En hier wordt gemeten.'],
                       wie='De praktijk'),
                  dict(naam='PARADISE', sub='De studie', groot='6',
                       onder='ziekenhuizen', vlak='glas', foto='merk.png',
                       regels=['Betaald door het FWO.',
                               'Wat werkt, kan daarna overal.'],
                       wie='De brug')],
         tip='Noem iemand van AZ Groeninge bij naam als die in de zaal zit.',
         interactie='Geen.'),
    ...
    dict(t='drieluik', voor='g', morph='morph',
         ...
         kaarten=[dict(naam='Voel de zool', sub='Aanraken', groot='1,9',
                       onder='millimeter', foto='pedar.png',
                       regels=['Dunner dan je denkt.',
                               'Mag je gerust vasthouden.'],
                       wie='Bij de stand'),
                  dict(naam='Meet je stap', sub='Wandelen', groot='10',
                       onder='meter', icoon='wandel',
                       regels=['Wandel met de zolen in je schoen.',
                               'Zie je eigen kleurenkaart.'],
                       wie='Doe mee'),
                  dict(naam='Stel je vraag', sub='Gesprek', groot='∞',
                       onder='vragen', vlak='glas', icoon='vraag',
                       regels=['Over voeten of over techniek.',
                               'Ook de gekke vragen.'],
                       wie='Wij staan er')],
         tip='Dit is de dia die mensen naar de stand brengt. Wijs waar u staat.',
         interactie='Vraag wie straks wil meten. Steek zelf uw hand op.'),

   dict(t='contact', voor='g', morph='morph',
      qr='qr_project.png', qr_voor='g',
      qr_kop='Meer weten?',
      qr_regel='Scan de code.',
      kicker='Bedankt voor uw aandacht',
      kop='Bedankt — kom langs',
      personen=[
          dict(naam='Janou De Buyser',
               rol='Onderzoeker · doet de metingen',
               waarvoor='Vraag me gerust alles over de zolen, de sensoren en '
                        'wat we ermee te weten komen.',
               bereik=['janou.debuyser@kuleuven.be',
                       'Vandaag op de stand']),
          dict(naam='prof. dr. Kevin Deschamps',
               rol='Leidt het onderzoek',
               waarvoor='Voor de vragen achter de vragen: waarom we dit meten '
                        'en wat we ermee willen bereiken.',
